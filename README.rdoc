...
* This plugin works only with Redmine 0.9.0 or higher.
...
6. Setup the permissions for the Niko-cale module for each of your roles.
...
* You can edit your feeling by clickiing [+] button.
